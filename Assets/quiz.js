...
var quizQuestions = [{
    ...
    correctAnswer: "a"},
  {
    ...
    correctAnswer: "b"},
   {
    ...
    correctAnswer: "a"},  
    {
    question: "Why was the JavaScript developer sad when he returned from the beach?",
    choiceA: "He had a syntax error in his sunscreen",
    choiceB: "He had a bug in his sandcastle",
    choiceC: "He couldn't find a semicolon in the waves",
    choiceD: "All of above",
    correctAnswer: "d"},
    {
    question: "What do you get when you mix a JavaScript developer with a bottle of water?",
    choiceA: "Null",
    choiceB: "Undefined",
    choiceC: "NaN",
